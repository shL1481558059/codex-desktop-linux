...
SCRIPT
    ...
    assert_contains "$pkg_root/DEBIAN/control" "Depends: at-spi2-core,"
    assert_contains "$pkg_root/DEBIAN/control" "xdotool"
    assert_contains "$pkg_root/DEBIAN/control" "x11-utils"
...
test_linux_computer_use_ui_opt_in_smoke() {
    ...
    local current_renderer_asset="$extracted/webview/assets/app-initial~app-main~quick-chat-window-page~work-home-page~chatgpt-conversation-page-BqLP6EDd.js"
